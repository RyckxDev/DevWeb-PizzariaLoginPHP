...
<head>
  ...
  <link rel="stylesheet" href="carrinho.css" media="all">
...
<body class="pagina-app">
  <div class="conteudo">
    ...
    <?php if (!empty($_SESSION['pedido_sucesso'])): ?>
    ...
    <?php else: ?>
      ...
      <div class="acoes-carrinho">
        ...
        <form method="post" action="carrinho.php">
          <button type="submit" name="finalizar_pedido" value="1">
            Finalizar Pedido
          </button>
        </form>

        <form method="post" action="carrinho.php">
          <button type="submit" name="limpar_carrinho" value="1">
            Limpar carrinho
          </button>
        </form>
      </div>
